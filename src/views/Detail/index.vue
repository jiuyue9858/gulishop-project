            ...
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  @click="changeCheck(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >
...
export default {
  ...
  // mounted之前存下来这个数据放到data里 ,后期想用比较简便
  beforeMount() {
    ...
    // 如果不成功,那么就呆在原地
      ...
      try {
        ...
        if(result === 'ok'){
          ...
          sessionStorage.setItem('SKUINFO_KEY', JSON.stringify(this.skuInfo))//转化为JSON串
